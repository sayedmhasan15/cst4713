...
<h1>
	...
	<form:form id="input" method="get" modelAttribute="input">
      <label for="countToNumber">number: </label>
		...
		<form:radiobutton path="mode" value= "321" name="mode"/> 321
		<form:radiobutton path="mode" value= "abc" name="mode"/> abc
		<form:radiobutton path="mode" value= "cba" name="mode"/> cba
		<br />
...
<c:forEach items ="${numbers}" var="n">
    <div class="${n.className}"> ${n.displayValue} </div>
</c:forEach>
</div>
</body>
</html>